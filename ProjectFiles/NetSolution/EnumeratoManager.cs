...
public class EnumeratoManager : BaseNetLogic
{
    public override void Start()
    {
        ...
        if (enumerationDataType != null)
        {
            ...
            if (index >= 0 && index < fields.Count)
            {
                ...
                label.LocalizedText = new LocalizedText(label.NodeId.NamespaceIndex,field.DisplayName.Text);
                Log.Info($"Set label to enumeration field: {field.DisplayName.Text}");
